...
function layup_display_icon()
{
    ...
    if ($gateway->payplan_disp == 'yes')
    {
        ...
        if ($layup_disable_meta != 'yes')
        {
            ...
            {
                $layup_preview_amount = (float)(($price - (($layup_preview_deposit_amount/100) * $price)) / ($layup_preview_months-1))/100;
            }
            elseif ($layup_preview_deposit_type == 'FLAT')
            {
                $layup_preview_amount = (float)(($price - $layup_preview_deposit_amount) / ($layup_preview_months-1))/100;
            }
            elseif ($layup_preview_deposit_type == 'INSTALMENT')
            {
                $layup_preview_amount = (float)($price / ($layup_preview_months))/100;
            }
